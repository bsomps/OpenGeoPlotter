...
event.key == '=': # Scale uniform bigger event.key == '-': # Scale uniform smaller event.key == 'a': # Scale left side in event.key == 'd': # Scale right side in event.key == 'j': # Scale left side out event.key == 'l': # Scale right side out event.key == 'w': # Scale top side down event.key == 'i': # Scale top side up event.key == 'k': # Scale bottom side down event.key == 's': # Scale bottom side up event.key == 'backspace': # Delete overlay image
